...
@SourceType(value = "FTPARP", label = "FTP",uiConfig = "ftp-layout.json")
public class FTPConf extends AbstractArpConf<FTPConf> {
  private static final String ARP_FILENAME = "arp/implementation/ftp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.ftp.FTPDriver";
